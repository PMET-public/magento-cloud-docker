...
interface BuilderInterface
{
    ...
    public const VOLUME_DOCKER_MNT = 'docker-mnt'; // = '.docker/mnt';
    public const VOLUME_MARIADB_CONF = 'mariadb-conf'; // ='.docker/mysql/mariadb.conf.d';
    ...
    public const VOLUME_MAGENTO_DEV = 'magento-dev'; // = './dev';
    public const VOLUME_DOCKER_ETRYPOINT = 'docker-entrypoint'; // = '.docker/mysql/docker-entrypoint-initdb.d';
    public const VOLUME_DOCKER_ETRYPOINT_QUOTE = 'docker-entrypoint-quote'; // = '.docker/mysql-quote/docker-entrypoint-initdb.d';
    public const VOLUME_DOCKER_ETRYPOINT_SALES = 'docker-entrypoint-sales'; // = '.docker/mysql-sales/docker-entrypoint-initdb.d';
